...
export default function AddPlayerModal() {
    ...
    return (
        <div className="modal fade "  data-backdrop="static" data-keyboard="false" id="addPlayerModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                            ...
                            <div className="d-flex flex align-items-center">
                                ...
                                {isAddMore ? <button className='btn ml-3 submit_player submit_player_disabled'  >
                                    ...
                                    <button className='btn ml-3 submit_player'
